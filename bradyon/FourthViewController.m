...
- (void)loadData
{
    ...
    titleString=[userDefaults stringForKey:@"TITLE4"];
    titleString=titleString?titleString:@"tab4";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString=[userDefaults stringForKey:@"URL4"];
    ...
    reloadTime=[userDefaults integerForKey:@"RELOAD4"];
...
- (void)saveData:(int)index
{
    ...
    if(index==0)
        [userDefaults setObject:titleString forKey:@"TITLE4"];
    else if(index==1)
        [userDefaults setObject:urlString forKey:@"URL4"];
    else if(index==2)
        [userDefaults setInteger:reloadTime forKey:@"RELOAD4"];
