...
- (void)loadView {
    ...
    {
        self.contentView = [[UIView alloc] initWithFrame:CGRectMake((bounds.size.width-320)/2, 0, 320, bounds.size.height)];
...
/*    if(_bodyFont)
    ...
    _bodyFont= [UIFont fontWithName:@"Helvetica-Bold" size:18];
    return _bodyFont;
}
