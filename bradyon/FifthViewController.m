...
- (void)loadData
{
    ...
    titleString=[userDefaults stringForKey:@"TITLE5"];
    titleString=titleString?titleString:@"tab5";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString=[userDefaults stringForKey:@"URL5"];
    ...
    titleString4=[userDefaults stringForKey:@"TITLE3"];
    titleString4=titleString4?titleString4:@"tab3";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString4=[userDefaults stringForKey:@"URL3"];
    urlString4=urlString4?urlString4:@"http://google.com";     //NULL化されていた場合はGoogleURLを設定
    
    titleString5=[userDefaults stringForKey:@"TITLE4"];
    titleString5=titleString5?titleString5:@"tab4";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString5=[userDefaults stringForKey:@"URL4"];
    urlString5=urlString5?urlString5:@"http://google.com";     //NULL化されていた場合はGoogleURLを設定
    
    reloadTime=[userDefaults integerForKey:@"RELOAD5"];
...
- (void)saveData:(int)index
{
    ...
    if(index==0)
        [userDefaults setObject:titleString forKey:@"TITLE5"];
    else if(index==1)
        [userDefaults setObject:urlString forKey:@"URL5"];
    else if(index==2)
        [userDefaults setInteger:reloadTime forKey:@"RELOAD5"];
