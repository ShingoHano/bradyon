...
- (void)loadData
{
    ...
    titleString=[userDefaults stringForKey:@"TITLE1"];
    titleString=titleString?titleString:@"tab1";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString=[userDefaults stringForKey:@"URL1"];
    urlString=urlString?urlString:@"http://google.com";     //NULL化されていた場合はGoogleURLを設定
    
    titleString2=[userDefaults stringForKey:@"TITLE2"];
    titleString2=titleString2?titleString2:@"tab2";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString2=[userDefaults stringForKey:@"URL2"];
    urlString2=urlString2?urlString2:@"http://google.com";     //NULL化されていた場合はGoogleURLを設定
    
    titleString3=[userDefaults stringForKey:@"TITLE3"];
    titleString3=titleString3?titleString3:@"tab3";            //NULL化されていた場合は"デフォルトタブ名を設定
    urlString3=[userDefaults stringForKey:@"URL3"];
    ...
    reloadTime=[userDefaults integerForKey:@"RELOAD1"];
...
- (void)saveData:(int)index
{
    ...
    if(index==0)
        [userDefaults setObject:titleString forKey:@"TITLE1"];
    else if(index==1)
        [userDefaults setObject:urlString forKey:@"URL1"];
    else if(index==2)
        [userDefaults setInteger:reloadTime forKey:@"RELOAD1"];
...
- (void)viewDidLoad
{
    ...
    //UIToolbarの生成
    UIToolbar *toolBar = [[UIToolbar alloc]initWithFrame:CGRectMake(0,w_height-40, frame.size.width, 40)];
    ...
    touchView.frame=CGRectMake(0, 0, frame.size.width, 40);
    ...
    webView.frame=CGRectMake(0, 0, w_width, w_height-40);
