...
@interface FirstViewController : UIViewController <UIWebViewDelegate,UITextFieldDelegate,UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,DDSocialDialogDelegate>
{
