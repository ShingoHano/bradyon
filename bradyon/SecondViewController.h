...
@interface SecondViewController : UIViewController <UIWebViewDelegate,UITextFieldDelegate,UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource,DDSocialDialogDelegate>
{
